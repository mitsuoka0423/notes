...
> 画面イメージが異なる方は、デフォルトIDEがVSCodeになっている可能性があります。
> 説明資料ではTheiaで説明するので、必要に応じて設定変更してください。
> https://note.com/kitazaki/n/n121a29a43a46
